...
const navItems = [
  ...
  { href: "/student/courses", label: "Fanlar", icon: BookOpen },
  { href: "/student/my-courses", label: "Mening darslarim", icon: GraduationCap },
  { href: "/student/recommendations", label: "Tavsiyalar", icon: Lightbulb },
]
          ...
          <DropdownMenuTrigger asChild>
            <Button variant="ghost" className="w-full justify-start gap-3 px-3 py-6 h-auto">
              ...
              <div className="flex-1 text-left">
                ...
                <p className="text-xs text-sidebar-foreground/60 truncate">O'quvchi</p>
              </div>
